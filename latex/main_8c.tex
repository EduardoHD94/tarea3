...
\begin{DoxyCompactList}\small\item\em The main program that do the bubblesort by Eduardo\+HD. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
The main program that do the bubblesort by Eduardo\+HD. 
